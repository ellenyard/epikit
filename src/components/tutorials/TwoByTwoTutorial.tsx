...
export const TwoByTwoTutorial: React.FC = () => {
  ...
  return (
    <div className="border border-orange-200 rounded-lg bg-orange-50 mb-4">
      <button
        onClick={() => setIsExpanded(!isExpanded)}
        className="w-full px-5 py-4 flex items-center justify-between text-left hover:bg-orange-100 transition-colors rounded-lg"
      ...
      >
        <div className="flex items-center">
          ...
          <div>
            <h3 className="font-semibold text-orange-900 text-lg">How to Use This Tool</h3>
            <p className="text-sm text-orange-700">Click to view step-by-step guidance</p>
          </div>
        </div>
        <svg
          className={`w-6 h-6 text-orange-700 transition-transform ${isExpanded ? 'transform rotate-180' : ''}`}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <div className="px-5 pb-5 space-y-4">
          <div className="bg-white border border-orange-200 rounded-lg p-4">
            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
              ...
              What are 2×2 Tables & Attack Rates?
            </h4>
          ...
          <div className="bg-white border border-orange-200 rounded-lg p-4">
            ...
            <ol className="space-y-2 text-sm text-gray-700">
              <li className="flex items-start">
                <span className="font-bold text-orange-600 mr-2 mt-0.5">1.</span>
                <div>
              ...
              <li className="flex items-start">
                <span className="font-bold text-orange-600 mr-2 mt-0.5">2.</span>
                <div>
              ...
              <li className="flex items-start">
                <span className="font-bold text-orange-600 mr-2 mt-0.5">3.</span>
                <div>
              ...
              <li className="flex items-start">
                <span className="font-bold text-orange-600 mr-2 mt-0.5">4.</span>
                <div>
